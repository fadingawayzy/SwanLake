---
aliases: ["Приём · вклад_переменный_процент", "вклад_переменный_процент"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/вклад_переменный_процент]
technique: вклад_переменный_процент
---

# Приём · вклад_переменный_процент

> [!abstract] Описание
> Вклад с меняющейся ставкой
...
FROM #ege/technique/вклад_переменный_процент AND -#ege/moc

---
aliases: ["Приём · xor_шифрование", "xor_шифрование"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/xor_шифрование]
technique: xor_шифрование
---

# Приём · xor_шифрование

> [!abstract] Описание
> Шифрование через XOR с ключом
...
FROM #ege/technique/xor_шифрование AND -#ege/moc

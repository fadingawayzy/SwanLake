---
aliases: ["Приём · противоречие", "противоречие"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/противоречие]
technique: противоречие
---

# Приём · противоречие

> [!abstract] Описание
> Выявить логическое противоречие
...
FROM #ege/technique/противоречие AND -#ege/moc

---
aliases: ["Приём · ascii_unicode", "ascii_unicode"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/ascii_unicode]
technique: ascii_unicode
---

# Приём · ascii_unicode

> [!abstract] Описание
> Различить ASCII и Unicode по примеру
...
FROM #ege/technique/ascii_unicode AND -#ege/moc

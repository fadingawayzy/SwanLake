---
aliases: ["Приём · признаки_разговорной", "признаки_разговорной"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/признаки_разговорной]
technique: признаки_разговорной
---

# Приём · признаки_разговорной

> [!abstract] Описание
> Найти признаки разговорной речи в тексте
...
FROM #ege/technique/признаки_разговорной AND -#ege/moc

---
aliases: ["Приём · цепочка", "цепочка"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/цепочка]
technique: цепочка
---
...
> [!abstract] Описание
> Составная задача — последовательные изменения
...
FROM #ege/technique/цепочка AND -#ege/moc

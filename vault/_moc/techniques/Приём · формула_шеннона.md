---
aliases: ["Приём · формула_шеннона", "формула_шеннона"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/формула_шеннона]
technique: формула_шеннона
---

# Приём · формула_шеннона

> [!abstract] Описание
> Расчёт по формуле Шеннона для неравновероятных
...
FROM #ege/technique/формула_шеннона AND -#ege/moc

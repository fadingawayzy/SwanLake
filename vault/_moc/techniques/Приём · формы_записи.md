---
aliases: ["Приём · формы_записи", "формы_записи"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/формы_записи]
technique: формы_записи
---

# Приём · формы_записи

> [!abstract] Описание
> Перевод между алгебраической, тригонометрической, показательной
...
FROM #ege/technique/формы_записи AND -#ege/moc

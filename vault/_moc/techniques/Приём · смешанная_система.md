---
aliases: ["Приём · смешанная_система", "смешанная_система"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/смешанная_система]
technique: смешанная_система
---

# Приём · смешанная_система

> [!abstract] Описание
> Уравнения разных типов в одной системе
...
FROM #ege/technique/смешанная_система AND -#ege/moc

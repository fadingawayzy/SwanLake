---
aliases: ["Приём · тропы_фигуры", "тропы_фигуры"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/тропы_фигуры]
technique: тропы_фигуры
---

# Приём · тропы_фигуры

> [!abstract] Описание
> Найти все тропы и фигуры в отрывке
...
FROM #ege/technique/тропы_фигуры AND -#ege/moc

---
aliases: ["Приём · перцептрон", "перцептрон"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/перцептрон]
technique: перцептрон
---

# Приём · перцептрон

> [!abstract] Описание
> Простой перцептрон — задача классификации
...
FROM #ege/technique/перцептрон AND -#ege/moc

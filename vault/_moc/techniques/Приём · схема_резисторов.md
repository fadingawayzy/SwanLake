---
aliases: ["Приём · схема_резисторов", "схема_резисторов"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/схема_резисторов]
technique: схема_резисторов
---

# Приём · схема_резисторов

> [!abstract] Описание
> Сложная схема с мостом / звездой
...
FROM #ege/technique/схема_резисторов AND -#ege/moc

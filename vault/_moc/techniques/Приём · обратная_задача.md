---
aliases: ["Приём · обратная_задача", "обратная_задача"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/обратная_задача]
technique: обратная_задача
---

# Приём · обратная_задача

> [!abstract] Описание
> Найти исходное число по остаткам/цифрам
...
FROM #ege/technique/обратная_задача AND -#ege/moc

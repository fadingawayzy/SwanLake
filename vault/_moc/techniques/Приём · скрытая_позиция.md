---
aliases: ["Приём · скрытая_позиция", "скрытая_позиция"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/скрытая_позиция]
technique: скрытая_позиция
---

# Приём · скрытая_позиция

> [!abstract] Описание
> Знак препинания в незаметной позиции
...
FROM #ege/technique/скрытая_позиция AND -#ege/moc

---
aliases: ["Приём · перекодирование", "перекодирование"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/перекодирование]
technique: перекодирование
---

# Приём · перекодирование

> [!abstract] Описание
> Перевести в таблицу/схему
...
FROM #ege/technique/перекодирование AND -#ege/moc

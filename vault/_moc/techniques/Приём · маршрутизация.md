---
aliases: ["Приём · маршрутизация", "маршрутизация"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/маршрутизация]
technique: маршрутизация
---

# Приём · маршрутизация

> [!abstract] Описание
> Анализ маршрутизации между подсетями
...
FROM #ege/technique/маршрутизация AND -#ege/moc

---
aliases: ["Приём · геометрия", "геометрия"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/геометрия]
technique: геометрия
---
...
> [!abstract] Описание
> Геометрическая интерпретация на комплексной плоскости
...
FROM #ege/technique/геометрия AND -#ege/moc

---
aliases: ["Приём · период_сложной", "период_сложной"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/период_сложной]
technique: период_сложной
---

# Приём · период_сложной

> [!abstract] Описание
> Период функции вида sin(ax)+cos(bx)
...
FROM #ege/technique/период_сложной AND -#ege/moc

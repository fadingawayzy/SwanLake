---
aliases: ["Приём · численное_дифференцирование", "численное_дифференцирование"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/численное_дифференцирование]
technique: численное_дифференцирование
---

# Приём · численное_дифференцирование

> [!abstract] Описание
> Конечные разности для производной
...
FROM #ege/technique/численное_дифференцирование AND -#ege/moc

---
aliases: ["Приём · концептуальная", "концептуальная"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/концептуальная]
technique: концептуальная
---

# Приём · концептуальная

> [!abstract] Описание
> Извлечь концептуальную позицию автора
...
FROM #ege/technique/концептуальная AND -#ege/moc

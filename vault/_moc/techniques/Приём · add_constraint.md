---
aliases: ["Приём · add_constraint", "add_constraint"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/add_constraint]
technique: add_constraint
---

# Приём · add_constraint

> [!abstract] Описание
> Добавить ограничительное условие, сужающее множество решений
...
FROM #ege/technique/add_constraint AND -#ege/moc

---
aliases: ["Приём · неопределённость", "неопределённость"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/неопределённость]
technique: неопределённость
---

# Приём · неопределённость

> [!abstract] Описание
> Соотношение неопределённостей Гейзенберга (over-edu)
...
FROM #ege/technique/неопределённость AND -#ege/moc

---
aliases: ["Приём · неинерциальная", "неинерциальная"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/неинерциальная]
technique: неинерциальная
---

# Приём · неинерциальная

> [!abstract] Описание
> Перейти в НИСО (силы инерции)
...
FROM #ege/technique/неинерциальная AND -#ege/moc

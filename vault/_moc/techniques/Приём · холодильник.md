---
aliases: ["Приём · холодильник", "холодильник"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/холодильник]
...
> [!abstract] Описание
> Холодильная машина — коэффициент
...
FROM #ege/technique/холодильник AND -#ege/moc

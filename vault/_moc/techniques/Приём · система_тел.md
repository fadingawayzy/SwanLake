---
aliases: ["Приём · система_тел", "система_тел"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/система_тел]
technique: система_тел
---

# Приём · система_тел

> [!abstract] Описание
> Система связанных тел (блоки, нити)
...
FROM #ege/technique/система_тел AND -#ege/moc

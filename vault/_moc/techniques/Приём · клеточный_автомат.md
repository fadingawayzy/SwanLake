---
aliases: ["Приём · клеточный_автомат", "клеточный_автомат"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/клеточный_автомат]
technique: клеточный_автомат
---

# Приём · клеточный_автомат
...
FROM #ege/technique/клеточный_автомат AND -#ege/moc

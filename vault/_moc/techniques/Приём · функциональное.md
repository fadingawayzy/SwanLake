---
aliases: ["Приём · функциональное", "функциональное"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/функциональное]
technique: функциональное
---

# Приём · функциональное

> [!abstract] Описание
> Подобрать функцию f, удовлетворяющую уравнению
...
FROM #ege/technique/функциональное AND -#ege/moc

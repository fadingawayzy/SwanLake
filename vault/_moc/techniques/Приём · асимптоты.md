---
aliases: ["Приём · асимптоты", "асимптоты"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/асимптоты]
technique: асимптоты
---
...
> [!abstract] Описание
> Все три типа асимптот (вертикальная, горизонтальная, наклонная)
...
FROM #ege/technique/асимптоты AND -#ege/moc

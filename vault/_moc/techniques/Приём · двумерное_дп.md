---
aliases: ["Приём · двумерное_дп", "двумерное_дп"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/двумерное_дп]
technique: двумерное_дп
---

# Приём · двумерное_дп

> [!abstract] Описание
> ДП на сетке/строках (LCS, knapsack)
...
FROM #ege/technique/двумерное_дп AND -#ege/moc

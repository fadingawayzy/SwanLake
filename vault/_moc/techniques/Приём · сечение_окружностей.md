---
aliases: ["Приём · сечение_окружностей", "сечение_окружностей"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/сечение_окружностей]
technique: сечение_окружностей
---

# Приём · сечение_окружностей

> [!abstract] Описание
> Взаимное расположение окружностей с касательными
...
FROM #ege/technique/сечение_окружностей AND -#ege/moc

---
aliases: ["Приём · смешивание", "смешивание"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/смешивание]
...
> [!abstract] Описание
> Смешать два вещества с фазовым переходом
...
FROM #ege/technique/смешивание AND -#ege/moc

---
aliases: ["Приём · две_прохода", "две_прохода"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/две_прохода]
technique: две_прохода
---

# Приём · две_прохода

> [!abstract] Описание
> Задача с двумя проходами
...
FROM #ege/technique/две_прохода AND -#ege/moc

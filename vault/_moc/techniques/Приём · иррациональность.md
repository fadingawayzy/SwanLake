---
aliases: ["Приём · иррациональность", "иррациональность"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/иррациональность]
technique: иррациональность
---

# Приём · иррациональность
...
FROM #ege/technique/иррациональность AND -#ege/moc

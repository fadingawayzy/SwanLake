---
aliases: ["Приём · подстроки", "подстроки"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/подстроки]
technique: подстроки
---
...
> [!abstract] Описание
> Поиск всех вхождений подстроки (КМП)
...
FROM #ege/technique/подстроки AND -#ege/moc

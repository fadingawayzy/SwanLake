---
aliases: ["Приём · построить_иерархию", "построить_иерархию"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/построить_иерархию]
technique: построить_иерархию
---

# Приём · построить_иерархию
...
FROM #ege/technique/построить_иерархию AND -#ege/moc

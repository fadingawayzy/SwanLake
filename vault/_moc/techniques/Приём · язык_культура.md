---
aliases: ["Приём · язык_культура", "язык_культура"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/язык_культура]
technique: язык_культура
---

# Приём · язык_культура

> [!abstract] Описание
> Связь языка и культурной картины мира
...
FROM #ege/technique/язык_культура AND -#ege/moc

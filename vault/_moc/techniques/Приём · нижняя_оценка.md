---
aliases: ["Приём · нижняя_оценка", "нижняя_оценка"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/нижняя_оценка]
technique: нижняя_оценка
---

# Приём · нижняя_оценка

> [!abstract] Описание
> Доказать нижнюю оценку сложности
...
FROM #ege/technique/нижняя_оценка AND -#ege/moc

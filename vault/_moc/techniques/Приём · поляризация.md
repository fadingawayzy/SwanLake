---
aliases: ["Приём · поляризация", "поляризация"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/поляризация]
technique: поляризация
---

# Приём · поляризация

> [!abstract] Описание
> Закон Малюса (over-edu)
...
FROM #ege/technique/поляризация AND -#ege/moc

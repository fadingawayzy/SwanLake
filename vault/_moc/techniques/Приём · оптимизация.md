---
aliases: ["Приём · оптимизация", "оптимизация"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/оптимизация]
technique: оптимизация
---

# Приём · оптимизация

> [!abstract] Описание
> Переписать программу с оптимизацией
...
FROM #ege/technique/оптимизация AND -#ege/moc

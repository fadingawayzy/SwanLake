---
aliases: ["Приём · условная", "условная"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/условная]
technique: условная
---
...
> [!abstract] Описание
> Условная вероятность, зависимые события
...
FROM #ege/technique/условная AND -#ege/moc

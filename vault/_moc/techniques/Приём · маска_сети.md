---
aliases: ["Приём · маска_сети", "маска_сети"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/маска_сети]
technique: маска_сети
---

# Приём · маска_сети

> [!abstract] Описание
> Расчёт диапазона IP по маске
...
FROM #ege/technique/маска_сети AND -#ege/moc

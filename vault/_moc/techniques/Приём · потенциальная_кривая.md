---
aliases: ["Приём · потенциальная_кривая", "потенциальная_кривая"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/потенциальная_кривая]
technique: потенциальная_кривая
---

# Приём · потенциальная_кривая

> [!abstract] Описание
> Анализ движения по потенциальной кривой
...
FROM #ege/technique/потенциальная_кривая AND -#ege/moc

---
aliases: ["Приём · площадь_векторы", "площадь_векторы"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/площадь_векторы]
technique: площадь_векторы
---

# Приём · площадь_векторы

> [!abstract] Описание
> Площадь через векторы/координаты
...
FROM #ege/technique/площадь_векторы AND -#ege/moc

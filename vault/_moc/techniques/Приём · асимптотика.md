---
aliases: ["Приём · асимптотика", "асимптотика"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/асимптотика]
technique: асимптотика
---

# Приём · асимптотика

> [!abstract] Описание
> Определить O(f(n)) для нетривиального алгоритма
...
FROM #ege/technique/асимптотика AND -#ege/moc

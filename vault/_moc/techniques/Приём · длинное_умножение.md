---
aliases: ["Приём · длинное_умножение", "длинное_умножение"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/длинное_умножение]
technique: длинное_умножение
---

# Приём · длинное_умножение

> [!abstract] Описание
> Умножение столбиком в длинной арифметике
...
FROM #ege/technique/длинное_умножение AND -#ege/moc

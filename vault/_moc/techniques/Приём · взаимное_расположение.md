---
aliases: ["Приём · взаимное_расположение", "взаимное_расположение"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/взаимное_расположение]
technique: взаимное_расположение
---

# Приём · взаимное_расположение

> [!abstract] Описание
> Сравнить значения двух экспонент
...
FROM #ege/technique/взаимное_расположение AND -#ege/moc

---
aliases: ["Приём · отбор_корней", "отбор_корней"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/отбор_корней]
technique: отбор_корней
---

# Приём · отбор_корней

> [!abstract] Описание
> Отбор корней на нестандартном отрезке
...
FROM #ege/technique/отбор_корней AND -#ege/moc

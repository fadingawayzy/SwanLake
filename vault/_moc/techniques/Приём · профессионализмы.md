---
aliases: ["Приём · профессионализмы", "профессионализмы"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/профессионализмы]
technique: профессионализмы
---

# Приём · профессионализмы

> [!abstract] Описание
> Различить профессионализмы, жаргонизмы, термины
...
FROM #ege/technique/профессионализмы AND -#ege/moc

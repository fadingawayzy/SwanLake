---
aliases: ["Приём · переполнение", "переполнение"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/переполнение]
technique: переполнение
---

# Приём · переполнение

> [!abstract] Описание
> Обнаружить переполнение знакового типа
...
FROM #ege/technique/переполнение AND -#ege/moc

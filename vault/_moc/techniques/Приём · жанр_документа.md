---
aliases: ["Приём · жанр_документа", "жанр_документа"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/жанр_документа]
technique: жанр_документа
---

# Приём · жанр_документа

> [!abstract] Описание
> Определить жанр официального документа
...
FROM #ege/technique/жанр_документа AND -#ege/moc

---
aliases: ["Приём · шаблоны_glob", "шаблоны_glob"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/шаблоны_glob]
technique: шаблоны_glob
---

# Приём · шаблоны_glob

> [!abstract] Описание
> Подсчёт файлов по сложному шаблону (*, ?, [])
...
FROM #ege/technique/шаблоны_glob AND -#ege/moc

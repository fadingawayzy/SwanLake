---
aliases: ["Приём · минимизация", "минимизация"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/минимизация]
technique: минимизация
---

# Приём · минимизация

> [!abstract] Описание
> Минимизация ДНФ через карты Карно (over-edu)
...
FROM #ege/technique/минимизация AND -#ege/moc

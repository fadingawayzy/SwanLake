---
aliases: ["Приём · построить_сднф", "построить_сднф"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/построить_сднф]
technique: построить_сднф
---

# Приём · построить_сднф

> [!abstract] Описание
> Построить СДНФ по таблице истинности
...
FROM #ege/technique/построить_сднф AND -#ege/moc

---
aliases: ["Приём · аннотация_рецензия", "аннотация_рецензия"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/аннотация_рецензия]
technique: аннотация_рецензия
---

# Приём · аннотация_рецензия

> [!abstract] Описание
> Различить аннотацию и рецензию по признакам
...
FROM #ege/technique/аннотация_рецензия AND -#ege/moc

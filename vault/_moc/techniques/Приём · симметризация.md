---
aliases: ["Приём · симметризация", "симметризация"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/симметризация]
technique: симметризация
---

# Приём · симметризация

> [!abstract] Описание
> Симметризация выражения для упрощения
...
FROM #ege/technique/симметризация AND -#ege/moc

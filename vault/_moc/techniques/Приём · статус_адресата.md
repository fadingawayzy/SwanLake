---
aliases: ["Приём · статус_адресата", "статус_адресата"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/статус_адресата]
technique: статус_адресата
---

# Приём · статус_адресата

> [!abstract] Описание
> Учесть статус адресата при выборе формы
...
FROM #ege/technique/статус_адресата AND -#ege/moc

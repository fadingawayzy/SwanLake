---
aliases: ["Приём · площадь_поверхности", "площадь_поверхности"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/площадь_поверхности]
technique: площадь_поверхности
---

# Приём · площадь_поверхности

> [!abstract] Описание
> Полная площадь поверхности комбинированного тела
...
FROM #ege/technique/площадь_поверхности AND -#ege/moc

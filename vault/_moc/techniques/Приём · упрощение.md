---
aliases: ["Приём · упрощение", "упрощение"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/упрощение]
technique: упрощение
---
...
> [!abstract] Описание
> Упростить формулу булевой алгебры
...
FROM #ege/technique/упрощение AND -#ege/moc

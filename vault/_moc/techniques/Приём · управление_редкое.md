---
aliases: ["Приём · управление_редкое", "управление_редкое"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/управление_редкое]
technique: управление_редкое
---

# Приём · управление_редкое

> [!abstract] Описание
> Управление редких глаголов
...
FROM #ege/technique/управление_редкое AND -#ege/moc

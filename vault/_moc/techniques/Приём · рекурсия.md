---
aliases: ["Приём · рекурсия", "рекурсия"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/рекурсия]
technique: рекурсия
---
...
> [!abstract] Описание
> Восстановить рекурсивную функцию по результату
...
FROM #ege/technique/рекурсия AND -#ege/moc

---
aliases: ["Приём · слитное_раздельное", "слитное_раздельное"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/слитное_раздельное]
technique: слитное_раздельное
---

# Приём · слитное_раздельное

> [!abstract] Описание
> Слитное/дефисное/раздельное в сложных случаях
...
FROM #ege/technique/слитное_раздельное AND -#ege/moc

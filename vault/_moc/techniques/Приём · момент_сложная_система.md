---
aliases: ["Приём · момент_сложная_система", "момент_сложная_система"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/момент_сложная_система]
technique: момент_сложная_система
---

# Приём · момент_сложная_система

> [!abstract] Описание
> Равновесие системы рычагов / тел
...
FROM #ege/technique/момент_сложная_система AND -#ege/moc

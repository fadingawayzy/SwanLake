---
aliases: ["Приём · дискретизация", "дискретизация"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/дискретизация]
technique: дискретизация
---
...
FROM #ege/technique/дискретизация AND -#ege/moc

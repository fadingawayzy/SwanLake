---
aliases: ["Приём · стержень_в_поле", "стержень_в_поле"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/стержень_в_поле]
technique: стержень_в_поле
---

# Приём · стержень_в_поле
...
FROM #ege/technique/стержень_в_поле AND -#ege/moc

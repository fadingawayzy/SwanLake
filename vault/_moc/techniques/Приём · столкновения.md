---
aliases: ["Приём · столкновения", "столкновения"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/столкновения]
technique: столкновения
---

# Приём · столкновения

> [!abstract] Описание
> Упругие и неупругие удары в 2D
...
FROM #ege/technique/столкновения AND -#ege/moc

---
aliases: ["Приём · регулярные_выражения", "регулярные_выражения"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/регулярные_выражения]
technique: регулярные_выражения
---

# Приём · регулярные_выражения

> [!abstract] Описание
> Поиск/замена через регулярки
...
FROM #ege/technique/регулярные_выражения AND -#ege/moc

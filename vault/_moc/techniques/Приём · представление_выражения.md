---
aliases: ["Приём · представление_выражения", "представление_выражения"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/представление_выражения]
technique: представление_выражения
---

# Приём · представление_выражения

> [!abstract] Описание
> Дерево арифметического выражения, постфикс
...
FROM #ege/technique/представление_выражения AND -#ege/moc

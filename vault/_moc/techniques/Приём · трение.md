---
aliases: ["Приём · трение", "трение"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/трение]
technique: трение
---
...
> [!abstract] Описание
> Трение переменной величины / граница скольжения
...
FROM #ege/technique/трение AND -#ege/moc

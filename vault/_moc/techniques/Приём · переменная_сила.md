---
aliases: ["Приём · переменная_сила", "переменная_сила"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/переменная_сила]
technique: переменная_сила
---

# Приём · переменная_сила

> [!abstract] Описание
> Работа силы, зависящей от координаты
...
FROM #ege/technique/переменная_сила AND -#ege/moc

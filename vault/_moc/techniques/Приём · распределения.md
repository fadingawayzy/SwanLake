---
aliases: ["Приём · распределения", "распределения"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/распределения]
technique: распределения
---
...
FROM #ege/technique/распределения AND -#ege/moc

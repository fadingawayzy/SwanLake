---
aliases: ["Приём · компрессия", "компрессия"]
cssclasses: [ege-moc, ege-technique]
tags: [ege/moc/technique, ege/technique/компрессия]
technique: компрессия
---

# Приём · компрессия

> [!abstract] Описание
> Сжать текст в 3 раза без потери смысла
...
FROM #ege/technique/компрессия AND -#ege/moc
